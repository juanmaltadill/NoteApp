    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(check.isChecked() && tv1.getText().toString().equals("")){
                    flag = false;
                    Toast toast=Toast.makeText(getApplicationContext(),"La nota vence pero no se ha establecido fecha de vencimiento",Toast.LENGTH_LONG);
                    toast.show();
                }
                if(flag){
                    ...
                    nota = new Nota(titulo, contenido, vence, fecha, cat);
        ...
        switch(requestCode) {
            case (STATIC_INTEGER_VALUE) : {
                if (resultCode == Activity.RESULT_OK) {
                    String newText = data.getStringExtra(SeleccionarFechaHoraActivity.PUBLIC_STATIC_STRING_IDENTIFIER);
                    tv1.setText(newText);
                } break;
            }
        }
